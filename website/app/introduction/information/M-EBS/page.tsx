...
/* ---------- บาร์บน/ล่าง (สีเดิม เพิ่ม transition) ---------- */
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-slate-100">
      ...
      <div className="relative z-10 pt-16 pb-[72px] md:pb-[68px]">
            ...
            <div className="grid gap-8 md:grid-cols-[380px,1fr]">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur transition-all duration-500 hover:border-white/20">
                  ...
                  <div className="relative flex h-56 items-center justify-center">
                    <Image
                      ...
                      width={320}
                      height={160}
                      className="h-28 w-auto md:h-90 drop-shadow-[0_8px_30px_rgba(16,185,129,.35)] will-change-transform"
                      priority
                    />
                  </div>
              ...
              <div className="anim-fade-up-2">
                ...
                <p className="mt-4 text-lg text-slate-200/90">
                  ระบบเฝ้าระวังเหตุการณ์โรคและภัยสุขภาพ (โปรแกรมตรวจสอบข่าวการระบาด : Event-based Surveillance)
                  เป็นเครื่องมือสำคัญที่ใช้ในการตรวจจับการระบาด ดักจับข้อมูลที่มีแนวโน้มว่าจะเป็นความเสี่ยงต่อสาธารณะ
                  ทั้งจากแหล่งข่าวทางการ/ไม่เป็นทางการ เพื่อให้ได้ข้อมูลสำหรับการเตือนภัย ทำให้หน่วยงานสามารถตอบสนองต่อเหตุการณ์ได้รวดเร็วและมีประสิทธิภาพ
                  อย่างไรก็ตามระบบเดิมยังมีข้อจำกัดด้านการใช้งานและโครงสร้างข้อมูล จึงพัฒนาสู่
                  <b> M-EBS</b> ให้ทันสมัย ใช้งานง่าย เชื่อมโยงข้อมูลได้ดี และนำไปใช้ต่อได้สะดวก
                </p>

                <p className="mt-4 text-lg text-slate-200/90">
                  <span className="font-semibold">วัตถุประสงค์ (Objectives)</span><br />
                  • สร้างความรับรู้และการมีส่วนร่วมกับโปรแกรม M-EBS แก่ผู้บริหารกรมควบคุมโรค และหน่วยงานเครือข่าย<br />
                  • พัฒนาศักยภาพบุคลากรทั้งส่วนกลางและส่วนภูมิภาค ให้พร้อมรองรับการรายงานเหตุการณ์ผ่านโปรแกรม M-EBS
                </p>
        ...
        <section className="mx-auto mt-2 max-w-6xl px-5 md:px-8 anim-fade-up-3">
      ...
      <style jsx global>{`
        ...
        /* Smooth enter animations (สีเดิม ไม่แตะ) */
        @keyframes fade-up {
          0% { opacity: 0; transform: translateY(12px); }
          100% { opacity: 1; transform: translateY(0); }
        }
        .anim-fade-up    { opacity: 0; animation: fade-up .65s var(--ease-smooth)   .05s forwards; }
