...
export default function Page() {
  return (
    <main className="page">
      ...
      <div className="ph ph1" aria-hidden="true" />
      <div className="ph ph2" aria-hidden="true" />
      <div className="ph ph3" aria-hidden="true" />
      <div className="ph ph4" aria-hidden="true" />
...
.field label{
  ...
  pointer-events:none; background:linear-gradient(#fff,#fff) padding-box; padding:0 4px;
}
